...
class ProduksiController extends Controller
{
    public function index()
    {
        $produksi = DB::connection('second_db')
            ...
            ->select('tk.ticket_number as docket', 
                    'tk.customer', 
                    'jh.name as mutu', 
                    'tk.load_qty as qty', 
                    'tk.delivered_qty', 
    ...
    public function customer (array $customer=null,array $id_batchingplant=null, $startdate=null, $enddate=null){
        ...
        $Ddetail = DB::connection('second_db')
            ->table('bp_tickets')
            ->select('bp_tickets.customer as customer', 
        ...
        $Ddetail = $Ddetail->groupBy('bp_jobmix_header.name','bp_jobmix_header.consistency','bp_location.name','bp_location.code')->get();
