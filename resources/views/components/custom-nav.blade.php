...
@can($module->name)
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-{{$module->name}}" role="button" aria-expanded="false" aria-controls="sidebar-{{$module->name}}">
        <i class="icon">
        ...
        <span class="item-name">{{ ucfirst($module->title)}}</span>
        <i class="right-icon">
    ...
    <ul class="sub-nav collapse" id="sidebar-{{ $module->name}}" data-bs-parent="#sidebar">
