<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">Module</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    @can('batchingplant')
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-batchingplant" role="button" aria-expanded="false" aria-controls="sidebar-batchingplant">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="item-name">Batchingplant</span>
            <i class="right-icon">
        ...
        <ul class="sub-nav collapse" id="sidebar-batchingplant" data-bs-parent="#sidebar">
            @can('batchingplant-report')
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('batchingplant.report.index'))}} " href="{{ route('batchingplant.report.index')}}">
                    <i class="icon">
            ...
            <li class="nav-item">
                <a class="nav-link " href="">
                    ...
                    <span class="item-name">JMF</span>
                </a>
            </li>
            @endcan
            @can('batchingplant-materialusage-read')
            <li class="nav-item">
                <a class="nav-link " href="">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <span class="item-name">Material Usage</span>
                </a>
            </li>
            @endcan
        </ul>
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-widget" role="button" aria-expanded="false" aria-controls="sidebar-widget">
            ...
            <span class="item-name">Truck Scale</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-monitoring" role="button" aria-expanded="false" aria-controls="sidebar-monitoring">
            ...
            <span class="item-name">Smart Monitor</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
        ...
        <ul class="sub-nav collapse" id="sidebar-monitoring" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link " href="">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">Manage Users</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar">
            ...
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('permission.index'))}}" href="{{route('permission.index')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('role.permission.list'))}}" href="{{route('role.permission.list')}}">
                    ...
                    <i class="sidenav-mini-icon"> RHP </i>
                    <span class="item-name">Role Has Permission</span>
                </a>
            </li>
        </ul>
    </li>
